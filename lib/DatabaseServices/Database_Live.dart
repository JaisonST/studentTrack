...
class DatabaseLive {
  ...
  Future addRecordToHistory(String name,String grade, Timestamp t){
    ...
    }).then((value) => print('User moved to history')).catchError((error) => print('Failed to move user:$error'));
  }
  ...
  Future moveRecordFromLiveToHistory(String uid) async {
    ...
    Timestamp t;
      ...
      return live.doc(uid).delete().then((value) => print("User deleted")).catchError((error) => print("Failed to delete user: $error"));
  }
